...
export const getActiveContests = ({offset, limit, type, contestId, industry, awardSort, ownEntries}) => {

    return http.post('getAllContests', {offset, limit, type, contestId, industry, awardSort, ownEntries})
};
